...
(function( global ) {
      ...
      render: function( options ) {
        ...
        for (i = 0; i < this.rowsCount; i += 1) {
          ...
          for (j = 0; j < this.colsCount; j += 1) {
            ...
            $cell = $('<div class="cell ' + this.map_colour[cell_counter] + '">' + cell_content + '</div>').appendTo($row);
    ...
    global.InitialGrid = InitialGrid;
